...
if (mouse_x > btn_x && mouse_x < btn_x + btn_width &&
    mouse_y > btn_start_y && mouse_y < btn_start_y + btn_height) {
...
draw_set_color(c_white);
draw_text(btn_x + btn_width / 2, btn_start_y + btn_height / 2, "Start");

if (mouse_x > btn_x && mouse_x < btn_x + btn_width &&
    mouse_y > btn_settings_y && mouse_y < btn_settings_y + btn_height) {
    draw_set_color(make_color_rgb(100, 100, 255));
} else {
    draw_set_color(c_dkgray);
}
draw_rectangle(btn_x, btn_settings_y, btn_x + btn_width, btn_settings_y + btn_height, false);
draw_set_color(c_white);
draw_text(btn_x + btn_width / 2, btn_settings_y + btn_height / 2, "Controls");
